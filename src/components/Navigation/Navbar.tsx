...
const Navbar: React.FC<Props> = ({ isNavbarOpen, setIsNavMenuOpen }) => {
  const toggleNavMenu = useCallback(
    (): void => setIsNavMenuOpen((prevIsNavMenuOpen) => !prevIsNavMenuOpen),
    [setIsNavMenuOpen]
  );
    ...
    <nav className="navbar" aria-label="main navigation">
      <div className="container">
        <div className="navbar-brand">
          ...
          >
            <MainLogoImg />
            <h1 className="logo-title is-hidden-mobile" title="Back to top">
              Patrick
              <br />
              <span>Obermeier</span>
            </h1>
          ...
          <span className="navbar-item is-hidden-desktop navbar-mobile-cta" onClick={closeNavMenu}>
            <a
