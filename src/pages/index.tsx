                  ...
                  <div className="card-content has-text-justified">
                    ...
                    <div className="content">
                      <p>
                        ...
                        utilizing cloud functions to perform any of its backend functionality. Uses
                        Netlify Identity as an external auth provider &amp; Redux for internal state
                        management.
                      </p>
                    </div>
                    <div className="my-card-footer">
              ...
              <div className="column">
                <div className="card">
                  ...
                  <div className="card-content has-text-justified">
                    ...
                    <div className="content">
                      <p>
                        A multiplayer variant of the famous game &quot;Battleship&quot; implemented
                        with Node.js, Express &amp; Socket.io. Notable features are a game lobby to
                        create &amp; join games, in-game chat &amp; 2-player multiplayer.
                      </p>
                    </div>
                    <div className="my-card-footer">
                      <h4 className="subtitle is-6 has-text-centered">
                  ...
                  <div className="card-content has-text-justified">
                    ...
                    <div className="content">
                      <p>
                        ...
                        virtual decks of flashcards, build a library of questions and answers for a
                        specific topic and challenge themselves by taking quizzes and documenting
                  ...
                  <div className="card-content has-text-justified">
                    ...
                    <div className="content">
                      <p>
                        ...
                        &quot;backend&quot; is implemented as an in-client DB + fake API endpoints.
                      </p>
                    </div>
                    <div className="my-card-footer">
                      <h4 className="subtitle is-6 has-text-centered">
                ...
                <div className="card">
                  <div className="card-image">
                    <figure className="image is-4by3">
                      ...
                      >
                        <picture>
                          <source srcSet="./img/project_work_lpgametwist.webp" type="image/webp" />
                          <img
                            loading="lazy"
                  ...
                  <div className="card-content has-text-justified">
                    ...
                    <div className="content">
                      <p>
                        ...
                        duplication and make marketing content editable by anybody. Combined with a
                        focus on best-in-class loading speed optimizations this gives us a cutting
                ...
                <div className="card">
                  <div className="card-image">
                    <figure className="image is-4by3">
                      ...
                      >
                        <picture>
                          <source srcSet="./img/project_work_lpstargames.webp" type="image/webp" />
                          <img
                            loading="lazy"
                            width={1280}
                            height={960}
                  ...
                  <div className="card-content has-text-justified">
                    ...
                    <div className="content">
                      <p>
                        Due to the restrictive Google Play store policies regarding gambling apps we
                        had to create separate landing pages, where users can download an APK-file
                        instead, for all of our casino platforms. The most important aspect of this
                        site is explaining the download- and installation instructions in a simple
                        and concise manner.
                      </p>
                    </div>
                    <div className="my-card-footer">
                  ...
                  <div className="card-content has-text-justified">
                    ...
                    <div className="content">
                      <p>
                        ...
                        aspects related to SEO and optimizing loading speed were the most important
                        considerations during the creation of this site.
                      </p>
                    </div>
                    <div className="my-card-footer">
                      <h4 className="subtitle is-6 has-text-centered">
